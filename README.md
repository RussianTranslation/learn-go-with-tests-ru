...
Безусловно, наиболее эффективным способом было постепенное знакомство с основами языка путем просмотра [go by examples](https://gobyexample.com/), изучения примеров и обсуждения в группе. Это был более интерактивный подход, чем «читать главу x для домашнего задания».
